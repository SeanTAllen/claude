...
- If the project has voice or style guidelines (e.g., `/seans-voice`), load them — clarity should be evaluated within the project's established voice, not against a generic standard
